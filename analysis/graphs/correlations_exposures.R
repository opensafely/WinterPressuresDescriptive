...
# Determine the reduced exposure set used in the mutually adjusted model.
# This is derived from lib/active_analyses.rds (generated by analysis/active_analyses/active_analyses.R).
